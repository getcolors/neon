...
grep -q 'io.github.getcolors.neon.workflow/workflow' "$launcher"
...
[[ -f "$tmp/.colors/neon-fixture/compute/nodes/0/node-none.tf.json" ]]
...
# the NEON_LIB_ROOT builds above reuse red/node_modules and cannot see a
# missing peer.
red_launcher="$root/skills/package-neon-red/red"
...
[[ -f "$tmp/red-cold/.colors/neon-fixture/compute/nodes/0/node-none.tf.json" ]]
